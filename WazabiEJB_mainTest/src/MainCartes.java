	...
	public static void main(String[] args)
		...
		try {
			...
			while (true) {
				...
				Carte carte = listeCarte.get(numero);
				// AUCUN, SENS, JOUEUR
				switch (carte.getInput().name()) {
				case "AUCUN":
					System.out.println("Carte utilisée : " + carte.getId_carte() + " e : " + carte.getEffet());
					gestionPartie.utiliserCarte(carte.getId_carte());
					break;
				case "JOUEUR":
